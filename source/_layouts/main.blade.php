...
<html lang="pt-BR">
	...
	<script type="text/javascript">window.piperun_data = {"form":{"header":{"text":"Olá, gostaria de falar com você sobre...","background_color":"#075E54","color":"#FFFFFF"},"content":{"fields":[{"field":"name","template":"pessoa.nome","type":"Pessoa","name":"Nome","id":"item_17","required":true},{"field":"email","template":"pessoa.email","type":"Pessoa","name":"E-mail","id":"item_18","required":true},{"field":"mobile_phone","template":"pessoa.telefone","type":"Pessoa","name":"Celular","id":"item_19","required":true},{"field":"notes","template":"oportunidade.mensagem","type":"Oportunidade","name":"Mensagem","id":"item_0","required":false}],"background_color":"#ECE5DD","color":"#2F2F2F"},"button":{"text":"Enviar","background_color":"#25a9d4","color":"#FFFFFF"},"accept":{"text":"Eu concordo em receber comunicações de ofertas personalizadas de acordo com meus interesses.","color":"#2F2F2F"},"logo":{"color":"#25D366"}},"enterprise":"false","hash":"a00835cc-98f1-44e5-b7c6-1b4b61e8e499","identifier":"email","position":"bottom_right","origin":"WhatsApp","tags":["Redes Sociais"],"title":"WhatsApp {{ pessoa.nome }} - {{ oportunidade.data }}","contact_phone":"55991637123","success_page_url":"","rules":{"update":"true","filter_status_update":"open","filter_situation_update":"unfreezed","equal_pipeline":true,"status":"open","situation":"unfreezed","validate_cpf":"false","validate_cnpj":"false"}};</script><script src="https://whats.tools.crmpiperun.com/script.min.js" type="text/javascript"></script>
    </body>
</html>
