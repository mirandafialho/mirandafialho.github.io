    ...
    <div class="flex flex-1 justify-end items-center text-right px-4">
        ...
        >
            ...
            <input
                ...
                v-model="query"
                ref="search"
                class="relative block h-10 w-full lg:w-1/2 lg:focus:w-3/4 bg-gray-800 border border-gray-100 focus:border-blue-200 outline-none cursor-pointer text-gray-100 px-4 pb-0 pt-px transition-all duration-200 ease-out"
            ...
            <button
                ...
                class="absolute top-0 right-0 leading-snug font-400 text-3xl text-blue-200 hover:text-blue-400 focus:outline-none pr-7 md:pr-3"
                @click="reset"
            >&times;</button>

            <transition name="fade">
                <div v-if="query" class="absolute left-0 right-0 md:inset-auto w-full lg:w-3/4 text-left mb-4 md:mt-10">
                    <div class="flex flex-col bg-gray-800 border border-b-0 border-t-0 border-blue-400 rounded-b-lg shadow-search mx-4 md:mx-0">
                        <a
                            v-for="(result, index) in results"
                            class="bg-gray-800 hover:bg-blue-600 border-b border-blue-200 text-xl cursor-pointer p-4"
                        ...
                        >
                            ...
                            <span class="block font-normal text-gray-100 text-sm my-1" v-html="result.item.snippet"></span>
                        </a>
